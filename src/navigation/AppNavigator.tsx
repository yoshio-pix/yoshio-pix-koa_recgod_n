...
// let addUrl = '';
let kyoten = '保税'; //本部・保税・岡セラ・大ヶ池・運輸
let systemmode = 'N'; //黄色…N 赤色…1 青色…K
let addUrl = '_1';
// let kyoten = '岡セラ'; //本部・保税・岡セラ・大ヶ池・運輸
// let systemmode = 'N'; //黄色…N 赤色…1 青色…K
// let addUrl = '_2';
// let kyoten = '大ヶ池'; //本部・保税・岡セラ・大ヶ池・運輸
// let systemmode = 'N'; //黄色…N 赤色…1 青色…K
// let addUrl = '_3';
// let kyoten = '運輸'; //本部・保税・岡セラ・大ヶ池・運輸
// let systemmode = 'N'; //黄色…N 赤色…1 青色…K
// let addUrl = '_4';
let webSocketUrl =
  // 'wss://wpupisoyha.execute-api.ap-northeast-1.amazonaws.com/stage/'; //本部
  'wss://18fmbp6c9c.execute-api.ap-northeast-1.amazonaws.com/stage/'; //保税
...
const AppNavigator = () => {
  ...
  const setDest = useSetRecoilState(destState); //Recoil 車
